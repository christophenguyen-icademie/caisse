...
var ArticleService = /** @class */ (function () {
    ...
    ArticleService.prototype.getReferentielArticles = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_articles_mok__WEBPACK_IMPORTED_MODULE_3__["ECHANTILLONS_ARTICLES"]);
    };
    ArticleService.prototype.getArticleParCode = function (code) {
        return this.getReferentielArticles().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (value) { return value.find(function (x) { return x.code === code; }); }));
    };
    ArticleService.prototype.addArticle = function (article) {
        this.caddie.push(article);
        this.totalTTC.next(this.caddie.reduce(function (a, b) { return a + b.prix; }, 0));
        return this.getCaddie();
    };
    ArticleService.prototype.removeArticle = function (article) {
        var index = this.caddie.findIndex(function (x) { return x === article; });
        this.caddie.splice(index, 1);
        this.totalTTC.next(this.caddie.reduce(function (a, b) { return a + b.prix; }, 0));
        return this.getCaddie();
    };
    ArticleService.prototype.getCaddie = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.caddie);
    };
    ArticleService.prototype.getTotalTTC = function () {
...
var ArticlesComponent = /** @class */ (function () {
    ...
    ArticlesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.articleService.getCaddie().subscribe(function (caddie) {
            _this.articles = caddie;
        });
    };
    ArticlesComponent.prototype.supprimeArticle = function (article) {
...
var EnteteComponent = /** @class */ (function () {
    ...
    EnteteComponent.prototype.startTimer = function () {
        var _this = this;
...
var SaisieCodebarreComponent = /** @class */ (function () {
    function SaisieCodebarreComponent(articleService) {
        this.articleService = articleService;
        this.articleselectionne$ = null;
    }
    SaisieCodebarreComponent.prototype.ngOnInit = function () {
    };
    SaisieCodebarreComponent.prototype.input_onSearchChange = function (code) {
        this.getArticleParCode(code);
    };
    SaisieCodebarreComponent.prototype.getArticleParCode = function (code) {
        var _this = this;
        if (code.length === 8) {
            this.articleService.getArticleParCode(code).subscribe(function (article) { return _this.articleselectionne$ = article; });
        }
        else {
            this.articleselectionne$ = null;
        }
    };
    SaisieCodebarreComponent.prototype.input_onkeypress = function (evt) {
    ...
    SaisieCodebarreComponent.prototype.button_onClick = function () {
        this.ajouteArticle();
    };
    SaisieCodebarreComponent.prototype.ajouteArticle = function () {
    ...
    SaisieCodebarreComponent.ctorParameters = function () { return [
        { type: _article_service__WEBPACK_IMPORTED_MODULE_2__["ArticleService"] }
    ]; };
    ...
    return SaisieCodebarreComponent;
}());
...
var TotalComponent = /** @class */ (function () {
    function TotalComponent(articleService) {
        this.articleService = articleService;
        this.totalTTC = 0;
        this.totalHT = 0;
        this.totalTVA = 0;
    ...
    TotalComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.articleService.getTotalTTC().subscribe(function (total) {
            _this.totalTTC = total;
            _this.totalHT = _this.totalTTC / 1.2;
            _this.totalTVA = _this.totalTTC - _this.totalHT;
        });
    };
